...
void cpuid(u32 in_eax, u32 in_ecx, u32 *eax, u32 *ebx, u32 *ecx, u32* edx)
{
	asm volatile (
		"mov %4, %%eax \n\t"
		"mov %5, %%ecx \n\t"
		...
		"movl %%edx, (%3) \n\t"
		:
		:"r"(eax),"r"(ebx),"r"(ecx),"r"(edx),"r"(in_eax),"r"(in_ecx)
		:"eax","ebx","ecx","edx"
	);
}

#define ALIGNED_4K(x) (void *)((long)x+(0x1000-(long)x%0x1000))
int instruction_coverage()
{
	void *tmp;
	tmp = malloc(0x8000);
	void *mem_addr_int = ALIGNED_4K(tmp);
	tmp = malloc(0x8000);
	void *mem_addr_fp = ALIGNED_4K(tmp);
	tmp = malloc(0x2000);
	void *fpu_state_save = ALIGNED_4K(tmp);
	

	void *inner_call_ptr = inner_call;
	u32 cpuid_eax, cpuid_ebx, cpuid_ecx, cpuid_edx;
	cpuid(0x7, 0x0, &cpuid_eax, &cpuid_ebx, &cpuid_ecx, &cpuid_edx);
	printf("cpuid leaf 0x7 ebx = %x ecx = %x edx = %x\n", cpuid_ebx, cpuid_ecx, cpuid_edx);

	if (cpuid_ecx & (1 << 11)) {
		printf("CASCADE LAKE AVX512_VNNI supported.\n");
	}
	start_sample();
	//goto end;
asm("push %rsi");
...
// NI asm("vaesenc %xmm0, %xmm0, %xmm0"); 	//BX_ISA_AVX	_V128_VAESENC_VdqHdqWdq
// NI asm("vaesenclast %xmm0, %xmm0, %xmm0"); 	//BX_ISA_AVX	_V128_VAESENCLAST_VdqHdqWdq
...
#ifndef LOW_VERSION_GCC
// NI asm("vaesenc %ymm0, %ymm0, %ymm0"); 	//BX_ISA_VAES_VPCLMULQDQ	_V256_VAESENC_VdqHdqWdq
// NI asm("vaesenclast %ymm0, %ymm0, %ymm0"); 	//BX_ISA_VAES_VPCLMULQDQ	_V256_VAESENCLAST_VdqHdqWdq
...
//for cascade lake
//if (cpuid_ecx & (1 << 11)) {
//	asm("vpdpbusd %xmm0, %xmm0, %xmm0{%k1}"); 	//BX_ISA_AVX512_VNNI	_V512_VPDPBUSD_VdqHdqWdq_Kmask
//	asm("vpdpbusds %xmm0, %xmm0, %xmm0{%k1}"); 	//BX_ISA_AVX512_VNNI	_V512_VPDPBUSDS_VdqHdqWdq_Kmask
//	asm("vpdpwssd %xmm0, %xmm0, %xmm0{%k1}"); 	//BX_ISA_AVX512_VNNI	_V512_VPDPWSSD_VdqHdqWdq_Kmask
//	asm("vpdpwssds %xmm0, %xmm0, %xmm0{%k1}"); 	//BX_ISA_AVX512_VNNI	_V512_VPDPWSSDS_VdqHdqWdq_Kmask
//	asm("vpdpbusd %ymm0, %ymm0, %ymm0{%k1}"); 	//BX_ISA_AVX512_VNNI	_V512_VPDPBUSD_VdqHdqWdq_Kmask
//	asm("vpdpbusds %ymm0, %ymm0, %ymm0{%k1}"); 	//BX_ISA_AVX512_VNNI	_V512_VPDPBUSDS_VdqHdqWdq_Kmask
//	asm("vpdpwssd %ymm0, %ymm0, %ymm0{%k1}"); 	//BX_ISA_AVX512_VNNI	_V512_VPDPWSSD_VdqHdqWdq_Kmask
//	asm("vpdpwssds %ymm0, %ymm0, %ymm0{%k1}"); 	//BX_ISA_AVX512_VNNI	_V512_VPDPWSSDS_VdqHdqWdq_Kmask
//	asm("vpdpbusd %zmm0, %zmm0, %zmm0{%k1}"); 	//BX_ISA_AVX512_VNNI	_V512_VPDPBUSD_VdqHdqWdq_Kmask
//	asm("vpdpbusds %zmm0, %zmm0, %zmm0{%k1}"); 	//BX_ISA_AVX512_VNNI	_V512_VPDPBUSDS_VdqHdqWdq_Kmask
//	asm("vpdpwssd %zmm0, %zmm0, %zmm0{%k1}"); 	//BX_ISA_AVX512_VNNI	_V512_VPDPWSSD_VdqHdqWdq_Kmask
//	asm("vpdpwssds %zmm0, %zmm0, %zmm0{%k1}"); 	//BX_ISA_AVX512_VNNI	_V512_VPDPWSSDS_VdqHdqWdq_Kmask
//}
...
// NI asm("vaesenc %zmm0, %zmm0, %zmm0"); 	//BX_ISA_VAES_VPCLMULQDQ	_V512_VAESENC_VdqHdqWdq
// NI asm("vaesenclast %zmm0, %zmm0, %zmm0"); 	//BX_ISA_VAES_VPCLMULQDQ	_V512_VAESENCLAST_VdqHdqWdq
#ifndef LOW_VERSION_GCC
